package com.roborescuemod.world.agent.firebrigade.copy;
...
public class RenderSample extends RenderLiving<EntitySample> {
	private static final ResourceLocation CREEPER_TEXTURES = new ResourceLocation(
			"textures/entity/creeper/creeper.png");

	public RenderSample(RenderManager renderManagerIn) {
		super(renderManagerIn, new ModelCreeper(), 0.5F);
		this.addLayer(new LayerSampleCharge(this));
	}
